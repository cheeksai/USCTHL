...
def get_all_df():
    url = "https://docs.google.com/spreadsheets/d/1Itp69-_15wsWqn5Vm0OxnzVEftGKYgz8MH1J8-BjLFs/export?format=csv&gid=423436338"
...
venue_dictionary["Tennessee"] = 'Applebees Arena (Nashville, Tennessee).png'
...
def simulate_game(team1, team2):
    ...
    saves1 = shots2 - goals2
    saves2 = shots1 - goals1
    ...
    for p, m, s, team, player, formatted_time in all_goals:
        ...
        goal_number = all_df.loc[all_df['Player'] == player, 'Goals'].iloc[0] + player_goal_match_counter[player]
      ...
      <div class="team-row">
          ...
          <div class="team-box" style="border-color: {{ team_colors[result['team1']['name']][1] }};">
            <div class="team-content"
              ...
              <div class="team-info"
                   style="display: flex; flex-direction: column; justify-content: space-between; align-items: center; padding: 15px; flex: 1;">
              ...
              <div class="team-logo" style="border-left: 4px solid {{ team_colors[result['team1']['name']][1] }};">
          ...
          <div class="team-box" style="border-color: {{ team_colors[result['team2']['name']][1] }};">
            <div class="team-content"
              ...
              <div class="team-logo" style="border-right: 4px solid {{ team_colors[result['team2']['name']][1] }};">
        ...
        <div class="shots-saves-box">
          ...
          <div class="team-half">
            ...
            <div class="stat-line">
              Save Pct: {{ "{:.3f}".format(result["saves1"] / result["shots2"]) }}
            </div>
          </div>
          ...
          <div class="team-half">
            ...
            <div class="stat-line">
              Save Pct: {{ "{:.3f}".format(result["saves2"] / result["shots1"]) }}
            </div>
          </div>
        </div>
...
#conference No. seed
            result["team1"]["record"] = f"{conference1} No. {seed1}" if conference1 is not None else "N/A"
            result["team2"]["record"] = f"{conference2} No. {seed2}" if conference1 is not None else "N/A"
